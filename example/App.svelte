<main>
    ...
    <figure><pre class="prettyprint">
    <code>{'<Icon data={flag}/>'}</code>
    </pre></figure>

    <h2>Scale</h2>
    <p><Icon data={icons.language} scale="3"/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={language} scale="3"/>'}</code></pre></figure>

    <h2>Spin</h2>
    <p><Icon data={icons.refresh} spin/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={refresh} spin/>'}</code></pre></figure>

    <h2>Pulse</h2>
    <p><Icon data={icons.spinner} pulse/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={spinner} pulse/>'}</code></pre></figure>

    <h2>Flip</h2>
    <p><Icon data={icons.signal} flip="horizontal"/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={signal} flip="horizontal"/>'}</code></pre></figure>

    <h2>Label</h2>
    <p><small>Accessible for screen readers, etc.</small></p>
    <p><Icon data={icons.code} label="Source Code"/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={code} label="Source Code"/>'}</code></pre></figure>

    <h2>Custom Class</h2>
    <p><small>Additional classes for custom styling</small></p>
    <p><Icon data={icons.certificate} class="pinkIcon"/></p>
    <figure><pre class="prettyprint"><code>{'<Icon data={certificate} class="pinkIcon"/>'}</code></pre></figure>
...
{'</Icon>'}</code></pre></figure>
    ...
    <p>See <a href="https://github.com/RobBrazier/svelte-awesome#more-advanced-cases">readme</a> for further instructions.</p>
